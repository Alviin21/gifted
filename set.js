...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~euggyB7K#ncS_aQoKM0GLEpHzU6BeQ55mrsxOrSkzYgoN6XPbdp4", // Add sess Id here especially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "254702351657", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "Alviin21🗿🗿", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "Alviin21🗿🗿", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "Alviin21🗿🗿", // Added // Input Yours custom...
